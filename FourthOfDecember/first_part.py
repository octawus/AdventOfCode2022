...
no_of_containements = 0

def asert_if_contained(first_elf_set, second_elf_set):
...
for line in lines:
    ...
    if asert_if_contained(first_elf_set_of_sections, second_elf_set_of_sections):
        print(f"In this asignement there is containement {elf_asignements}")
        no_of_containements = no_of_containements + 1
    else:
        print(f"There is no containement {elf_asignements}")


print(no_of_containements)
